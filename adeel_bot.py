# ══════════════════════════════════════════════════════════════════════
#  🌟  KuP  ✦  PREMIUM  NUMBER  PANEL  •  v7  (FULL: MEMBER + ADMIN + LIVE)  🌟
#  ----------------------------------------------------------------
...
# ╚══════════════════════════════════════════════════════════╝
NUMEX_BOT_TOKEN    = "8570804997:AAHBtcVQ6fQHbuuaW643vaYphxBtax5ICmw"
NUMEX_BOT_USERNAME = "Aadibot7889_bot"
API_TOKEN          = NUMEX_BOT_TOKEN       # backward compat alias
ADMIN_ID           = 8190027280
ADMIN_USERNAME     = "MAdeel7889"          # without @
BOT_USERNAME       = NUMEX_BOT_USERNAME    # without @
BOT_NAME           = "🅺🆄🅿 🅾🆃🅿"
TRAFFIC_CHANNEL_LINK = "https://t.me/kupsupport_01"
OTP_CHAT_ID        = -1003921588568        # OTP forward group/channel id
OTP_GROUP_LINK     = "https://t.me/adeelotpbot7889"
RANGE_GROUP_LINK   = "https://t.me/adeelotpbot7889"
CURRENCY           = "৳"
MIN_WITHDRAW       = 1
...
VOLTX_API_KEY     = "MN7ASYE8S9L"
VOLTX_BASE_URL    = "https://api.2oo9.cloud/MXS47FLFX0U/tnevs/@public/api"
RANGE_CHANNEL_ID  = -5112413573            # range monitor channel (private)
RANGE_CHANNEL_PUBLIC_LINK = "https://t.me/adeelotpbot7889"
# ══════════════════════════════════════════════════════════════════════
...
def force_join_kb() -> types.InlineKeyboardMarkup:
    ...
    kb.add(types.InlineKeyboardButton("KuP CHANEL", url=TRAFFIC_CHANNEL_LINK))
...
def h_support(m):
    if anti_flood(m.from_user.id): return
    kb = types.InlineKeyboardMarkup()
    kb.add(types.InlineKeyboardButton("👨‍💻 Message Developer | Create Your Own Bot", url="https://t.me/NEXORA_X_SHAMIM"))
    kb.add(types.InlineKeyboardButton("👑 Message Admin", url=f"https://t.me/{ADMIN_USERNAME}"))
...
def otp_group_handler(m):
    ...
    with db() as conn:
        ...
        rows = conn.execute(
            "SELECT num, taken_by, cat, country FROM numbers "
...
if __name__ == "__main__":
    ...
    print("✅ KuP (FULL) running...")
    log.info("Bot started KuP")
    while True:
        try:
